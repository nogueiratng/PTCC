...
urlpatterns = [
    ...
    path('selecionar-crianca/<int:crianca_id>/', views.selecionar_crianca_view, name='selecionar_crianca'),
    ...
    path('comecar/<int:atividade_id>/', views.comecar_atividade_view, name='comecar_atividade'),
